import gleam/json
import gleeunit
import supabase.{create, delete, eq, execute, from, insert, rpc, select, update}
    ...
    json.object([
      ...
      #(
        ...
        json.object([
          ...
          #("timestamp", json.int(1_234_567_890)),
        ]),
      ),
    ])
...
pub fn multiple_operations_same_table_test() {
  ...
  let update_data = json.object([#("title", json.string("Updated Post"))])
